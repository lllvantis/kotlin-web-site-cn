...
#### Chocolatey 包
对于 Windows 下 [Chocolatey](https://chocolatey.org/) 用户，有一个社区维护的软件包 [kotlinc](https://chocolatey.org/packages/kotlinc) 可供使用，
您可以在命令行通过 [`choco install`](https://chocolatey.org/docs/commandsinstall) 命令来进行安装。
